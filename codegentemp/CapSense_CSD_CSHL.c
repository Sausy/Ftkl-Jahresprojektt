...
#if (CapSense_CSD_TUNING_METHOD == CapSense_CSD__TUNING_AUTO)
	extern CapSense_CSD_CONFIG_TYPE_P4_v2_10 CapSense_CSD_config;
#endif  /* (CapSense_CSD_TUNING_METHOD == CapSense_CSD__TUNING_AUTO) */
...
const uint16 CapSense_CSD_fingerThreshold[] = {
    50u, 
};

const uint16 CapSense_CSD_noiseThreshold[] = {
    3u, 
};

const uint16 CapSense_CSD_hysteresis[] = {
    10u, 
};

const uint8 CapSense_CSD_debounce[] = {
    2u, 
};
...
void CapSense_CSD_UpdateBaselineNoThreshold(uint32 sensor)
{
	...
	#if (CapSense_CSD_TUNING_METHOD == CapSense_CSD__TUNING_AUTO)
	    MeasureNoiseEnvelope_P4_v2_10(&CapSense_CSD_config, (uint8)sensor, CapSense_CSD_sensorRaw);
	#endif /* (CapSense_CSD_TUNING_METHOD == CapSense_CSD__TUNING_AUTO) */
...
void CapSense_CSD_DisableWidget(uint32 widget)
{
    ...
    *******************************************************************************/
    uint16 CapSense_CSD_GetCentroidPos(uint32 widget)
    {
		...
		#if (CapSense_CSD_IS_DIPLEX_SLIDER)        
			maximum = CapSense_CSD_FindMaximum(offset, count, (uint16)CapSense_CSD_fingerThreshold[widget], diplex);
		#else
			maximum = CapSense_CSD_FindMaximum(offset, count, (uint16)CapSense_CSD_fingerThreshold[widget]);
		#endif /* (CapSense_CSD_IS_DIPLEX_SLIDER) */
    ...
    *******************************************************************************/
     uint16 CapSense_CSD_GetRadialCentroidPos(uint32 widget)
    {
		...
		/* Find Maximum within centroid */      
		#if (CapSense_CSD_IS_DIPLEX_SLIDER)        
			maximum = CapSense_CSD_FindMaximum(offset, count, (uint16)CapSense_CSD_fingerThreshold[widget], 0u);
		#else
			maximum = CapSense_CSD_FindMaximum(offset, count, (uint16)CapSense_CSD_fingerThreshold[widget]);
		#endif /* (CapSense_CSD_IS_DIPLEX_SLIDER) */
