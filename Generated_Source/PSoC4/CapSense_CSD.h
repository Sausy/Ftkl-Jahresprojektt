...
#define CapSense_CSD_PORT_PIN_CONFIG_TBL_ZISE   (1u)
...
#if (CY_PSOC4_4200BL)
	#define CapSense_CSD_CFG_REG_TBL_SIZE		(6u)
#elif(0u == CapSense_CSD_M0S8CSD_BLOCK_VER)
	#define CapSense_CSD_CFG_REG_TBL_SIZE		(5u)
#else
	#define CapSense_CSD_CFG_REG_TBL_SIZE		(4u)	
...
#if (CY_PSOC4_4200BL)
    /* Port DR and PC registers */
	#define CapSense_CSD_PORT5_DR_REG           (*(reg32 *) CYREG_PRT5_DR )
	#define CapSense_CSD_PORT5_DR_PTR           ( (reg32 *) CYREG_PRT5_DR )

	/* Port DR and PC registers */
	#define CapSense_CSD_PORT5_PC_REG           (*(reg32 *) CYREG_PRT5_PC )
	#define CapSense_CSD_PORT5_PC_PTR           ( (reg32 *) CYREG_PRT5_PC )
#endif /* (CY_PSOC4_4200BL) */
...
#define CapSense_CSD_CSD_PIN_DRIVE_MASK         (0x00000001Lu)
	...
	#define CapSense_CSD_CSD_CMOD_CONNECTION_MASK   (0x0000000FLu)
	#define CapSense_CSD_CSD_CMOD_TO_AMUXBUS_A      (0x00000006Lu)
	#define CapSense_CSD_CSD_CMOD_TO_AMUXBUS_B      (0x00000007Lu)
	
	#define CapSense_CSD_CSD_CTANK_CONNECTION_MASK  (0x000000F0Lu)
	#define CapSense_CSD_CSD_CTANK_TO_AMUXBUS_A     (0x00000060Lu)
	#define CapSense_CSD_CSD_CTANK_TO_AMUXBUS_B     (0x00000070Lu)
	
	#define  CapSense_CSD_CSD_CMOD_PC_MASK          (0x00000007Lu)
	#define  CapSense_CSD_CSD_CTANK_PC_MASK         (0x00000038Lu)

	#define  CapSense_CSD_CMOD_PC_STRONG_MODE       (0x00000006Lu)
	#define  CapSense_CSD_CMOD_PC_HIGH_Z_MODE       (0x00000000Lu)

	#define  CapSense_CSD_CTANK_PC_STRONG_MODE      (0x00000030Lu)
	#define  CapSense_CSD_CTANK_PC_HIGH_Z_MODE      (0x00000000Lu)

	#define  CapSense_CSD_CMOD_DR_VSSIO 			(0x00000001Lu)
	#define  CapSense_CSD_CMOD_DR_VDDIO				(0x00000000Lu)
	#define  CapSense_CSD_CMOD_DR_MASK				(0x00000001Lu)

	#define  CapSense_CSD_CTANK_DR_VSSIO 			(0x00000002Lu)
	#define  CapSense_CSD_CTANK_DR_VDDIO			(0x00000000Lu)
	#define  CapSense_CSD_CTANK_DR_MASK 			(0x00000002Lu)
...
extern uint8 CapSense_CSD_unscannedSnsDriveMode[CapSense_CSD_TOTAL_SENSOR_COUNT];
