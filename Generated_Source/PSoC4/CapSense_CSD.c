...
/* This definition is intended to prevent unexpected linker error. 
   For more details please see the IAR Technical Note 49981 */
	...
	extern __INLINE void CapSense_CSD_EnableSensor(uint32 sensor);
	extern __INLINE void CapSense_CSD_DisableSensor(uint32 sensor);
#endif /* (__ICCARM__) */	
...
const uint8 CapSense_CSD_pinShiftTbl[] = {
    (uint8) CapSense_CSD_Sns__ProximitySensor0_0__PROX__SHIFT, 
};

const uint8 CapSense_CSD_modulationIDAC[CapSense_CSD_TOTAL_SENSOR_COUNT] = {
    120u, 
};
const uint32 CapSense_CSD_widgetResolution[CapSense_CSD_RESOLUTIONS_TBL_SIZE] = {
    CapSense_CSD_RESOLUTION_16_BITS,
};

const uint8 CapSense_CSD_senseClkDividerVal = 1u;
const uint8 CapSense_CSD_sampleClkDividerVal = 12u;
